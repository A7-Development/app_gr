...
// -----------------------------------------------------------------------------
// Fixture: Posicao da Carteira em % do PL
// Reproduz secao p.3 da lamina Austin
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
// Fixture: Posicao da Carteira em R$ mil
// -----------------------------------------------------------------------------
...
export default function CompactSeriesTablePreviewPage() {
  return (
    <div className="flex flex-col gap-6 px-12 py-6 pb-20">
      <PageHeader
        title="CompactSeriesTable · preview"
        info="Proposta de tabela canonica para series temporais (estilo Austin Rating). Dados ficticios. Use para validar densidade, ênfases e formato de data antes de migrar a FichaFundoTab."
      />
