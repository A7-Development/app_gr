...
const LINHA_TOOLTIP: Record<string, string> = {
  ...
  cpr_pagar:            "Contas a pagar: provisões de despesa (taxas, consultoria, auditoria) + IOF/IR a recolher. Por natureza do CPR — capital de cotista saiu para Obrigações com Cotistas.",
  cpr_obrigacoes_cotistas: "Obrigações com cotistas: Cotas a Resgatar, Aporte a integralizar/devolver, Resgate. Capital (patrimônio), NÃO é despesa — antes vazava para Contas a Pagar.",
