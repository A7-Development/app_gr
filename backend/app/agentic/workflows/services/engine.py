...
from app.agentic.workflows.nodes._base import NodeContext, NodeOutput
from app.agentic.workflows.nodes.registry import NODE_TYPES, get_node_class
from app.agentic.workflows.schemas.definition import EdgeSpec, NodeSpec, WorkflowGraph
from app.agentic.workflows.services.resolver import (
...
async def execute_paused_run(db: AsyncSession, *, run_id: UUID) -> WorkflowRun:
    ...
    for run in rows:
        ...
        await db.execute(
            ...
            .where(
                ...
                WorkflowRunStep.status == NodeRunStatus.RUNNING,
            )
...
async def _execute_node(
    ...
    *,
    ...
    """Instantiate and execute a single node. Persist its WorkflowRunStep row.
