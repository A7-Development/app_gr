...
@register_tool(
    ...
    description=(
        ...
        "material no balanco), USE esta tool pra saber se foi aporte/resgate de "
        "capital (entrou/saiu dinheiro novo — NEUTRO no PL Sub em R$, muda so o % "
        "de subordinacao) ou custo financeiro da cota (carrego, esse SIM pesa na "
        "Sub). Retorna por classe: patrimonio/quantidade/"
