...
async def compute_breakdown(
    ...
    *,
    ...
    `dim` ∈ {cedente, produto, subgrupo}. Os filtros opcionais
    `entidade_id`/`subgrupo` servem o DRILL (ex.: dim=subgrupo
    + entidade_id=X = subgrupos daquele cedente). Receita = SO linhas de
