...
async def upsert_pj_cadastro(
    ...
    *,
    ...
    values: dict[str, Any] = {
        ...
        "regime_tributario": fields.regime_tributario,
        "porte": fields.porte,
        "optante_simples": fields.optante_simples,
        "natureza_juridica_codigo": fields.natureza_juridica_codigo,
        "natureza_juridica": fields.natureza_juridica,
        "situacao_especial": fields.situacao_especial,
        "situacao_cadastral_desde": fields.situacao_cadastral_desde,
        "data_inicio_atividade": fields.data_inicio_atividade,
        "origem_cadastral": fields.origem_cadastral,
        "mudou_nome": fields.mudou_nome,
        "mudou_regime": fields.mudou_regime,
        "historico_nomes": fields.historico_nomes,
