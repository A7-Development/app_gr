"""Mapper: payload /netreport/report/market/tesouraria/{data} -> dict canonico.

Granularidade: 1 linha por (tenant, data, classe de cota). source_id =
`{clienteId}|{YYYY-MM-DD}` (cada `clienteId` representa uma classe de cota
distinta — REALINVEST, REALINVEST MEZ, REALINVEST SEN).
"""
